...
async def get_thumb(videoid):
    ...
    arial = ImageFont.truetype("LuckyX/assets/font2.ttf", 30)
    font = ImageFont.truetype("LuckyX/assets/font.ttf", 30)
    title_font = ImageFont.truetype("LuckyX/assets/font3.ttf", 45)
    ...
    play_icons = Image.open("LuckyX/assets/play_icons.png")
