...
def welcomepic(pic, user, chatname, id, uname):
    background = Image.open("LuckyX/assets/Lucky/LuckyNwel.png")
    pfp = Image.open(pic).convert("RGBA")
    pfp = circle(pfp)
    pfp = pfp.resize((823, 821))
    draw = ImageDraw.Draw(background)
    font_large = ImageFont.truetype('LuckyX/assets/Lucky/ArialReg.ttf', size=65)
    font_small = ImageFont.truetype('LuckyX/assets/Lucky/ArialReg.ttf', size=60)
